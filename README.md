...
```kotlin
dependencies {
    implementation/* OR api */("ir.mahozad.multiplatform:wavy-slider:0.8.0")
}
```
...
<tr>
<td> <img src="demo.svg" width="500px"> </td>
<td>
...
<tr>
<td> <img src="assets/logo-icon.svg" width="500px"> </td>
<td>
...
[Kotlin release]: https://github.com/JetBrains/kotlin/releases/tag/v1.9.21
[Compose Multiplatform release]: https://github.com/JetBrains/compose-multiplatform/releases/tag/v1.5.11
[Library on Maven Central]: https://repo1.maven.org/maven2/ir/mahozad/multiplatform/wavy-slider/0.8.0/
