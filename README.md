...
```kotlin
implementation("ir.mahozad.multiplatform:wavy-slider:1.2.0")
```
...
kotlin {
    sourceSets {
        commonMain.dependencies {
            implementation/* OR api */("ir.mahozad.multiplatform:wavy-slider:1.2.0")
            // ...
        }
// ...
```
...
[Library on Maven Central]: https://repo1.maven.org/maven2/ir/mahozad/multiplatform/wavy-slider/1.2.0/
